...
node scripts/gen-nav.js 'content/docs-cn/TOC.md' 'data/docs_cn_dev_toc.json' '/docs-cn/dev'
node scripts/gen-nav.js 'content/docs-cn/TOC.md' 'data/docs_cn_v30_toc.json' '/docs-cn/v3.0'
node scripts/gen-nav.js 'content/docs-cn/TOC.md' 'data/docs_cn_v21_toc.json' '/docs-cn/v2.1'
